...
const App = (() => {
  ...
  const q2 = new Question(
    'When was the JavaScript created?',
    ['June 1995', 'May 1995', 'July 1885', 'Sep 1996'],
    1
  )
  const q3 = new Question(
    'What does CSS stand for?',
    ['Country  Sheriff Service', 'Cascading Sexy Sheet', 'Cascading Style Sheet'],
    2
  )
  const q4 = new Question(
    'The full form of HTML is...',
    ['Hyper Text Markup Language', 'Hold the Mic', 'Error', 'All answers are false'],
    0
  )
  const q5 = new Question(
    'console.log(typeof []) would return what?',
    ['Array', 'Object', 'null', 'All answers are false'],
    1
  )
